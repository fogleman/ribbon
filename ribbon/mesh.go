...
func ModelMesh(model *pdb.Model, ch chan *fauxgl.Mesh) {
	RibbonMesh(model, ch)
	HetMesh(model, ch)
	close(ch)
}

func RibbonMesh(model *pdb.Model, ch chan *fauxgl.Mesh) {
...
func HetMesh(model *pdb.Model, ch chan *fauxgl.Mesh) {
